...
<script setup lang="ts">
  ...
  const fieldTreeSelectValue = computed(() => {
  ...
  function parseFieldSelection(value: string | undefined): FieldSelection | null {
    if (!value) {
      return null
    }
  ...
  function onFieldChange(newValue: string | undefined) {
