...
const buildFields = (
  ...
  const commonFields: InputField[] = [
    { key: "id", name: "id", type: "bigint" },
    { key: "createTime", name: "createTime", type: "datetime" },
    { key: "updateTime", name: "updateTime", type: "datetime" },
    { key: "isDelete", name: "isDelete", type: "tinyint" },
  ];
